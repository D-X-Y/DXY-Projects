...
dataset                     = [];
dataset                     = Dataset.voc2012_trainval_ss(dataset, 'train', use_flipped);
...
for idx = 1:numel(models)
    Corlocs{idx}            = weakly_test_Cor_v2({models{idx}.conf}, loc_dataset.imdb_train{1}, loc_dataset.roidb_train{1}, ...
...
Corlocs{end+1}              = weakly_test_Cor_v2(net_confs, loc_dataset.imdb_train{1}, loc_dataset.roidb_train{1}, ...
                                'net_defs',         net_defs, ...
...
fprintf('--------------------- Online VOC 2012 Test ---------------------\n');
net_models{1}               = '';
net_models{2}               = '';
net_models{3}               = '';
mAPs{numel(models)+1}       = weakly_online_test(net_confs, dataset.imdb_test, dataset.roidb_test, ...
                                'net_defs',         net_defs, ...
                                'net_models',       net_models, ...
                                'cache_name',       opts.cache_name,...
                                'log_prefix',       ['Triple_final_'],...
