...
models{3}.solver_def_file   = fullfile(pwd, 'models', 'rfcn_prototxts', 'VGG16_OHEM', 'solver_lr1_3.prototxt');
models{3}.test_net_def_file = fullfile(pwd, 'models', 'rfcn_prototxts', 'VGG16_OHEM', 'test.prototxt');
models{3}.net_file          = fullfile(pwd, 'models', 'pre_trained_models', 'VGG16', 'vgg16.caffemodel');
models{3}.cur_net_file      = 'unset';
models{3}.name              = 'Fast-VGG16-OHEM';
models{3}.mean_image        = fullfile(pwd, 'models', 'pre_trained_models', 'VGG16', 'mean_image.mat');
models{3}.conf              = rfcn_config_ohem('image_means', models{3}.mean_image, ...
                                                 'classes', extra_para.VOCopts.classes, ...
                                                 'max_epoch', 9, 'step_epoch', 8, 'regression', true);
box_param{3}                = load(fullfile(pwd, 'models', 'pre_trained_models', 'rfcn_box_param.mat'));

% cache name
opts.cache_name             = ['MSPLD-MM_', models{1}.name, '_', models{2}.name, '_', models{3}.name];
