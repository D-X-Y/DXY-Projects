...
% cache name
opts.cache_name             = ['Test_', models{1}.name, '_', models{2}.name, '_', models{3}.name];
...
opts.rfcn_model{1}          = fullfile(pwd, 'output', 'weakly_cachedir', 'INF-Rfcn-ResNet50-OHEM_seed-5', 'voc_2007_trainval', 'Rfcn-ResNet50-OHEM_final.caffemodel');
opts.rfcn_model{2}          = fullfile(pwd, 'output', 'weakly_cachedir', 'INF-Rfcn-ResNet101-SIMPLE_seed-5', 'voc_2007_trainval', 'Rfcn-ResNet101-SIMPLE_final.caffemodel');
opts.rfcn_model{3}          = fullfile(pwd, 'output', 'weakly_cachedir', 'INF-Fast-VGGNet16-SIMPLE_seed-5', 'voc_2007_trainval', 'Fast-VGGNet16-SIMPLE_final.caffemodel');
