...
NOISE                       = 1000;
% cache name
opts.cache_name             = ['NOISE_', num2str(NOISE), '_',  models{1}.name, '_', models{2}.name, '_', models{3}.name];
...
dataset                     = [];
dataset                     = Dataset.noise_voc07_ss(dataset, NOISE, use_flipped);
dataset                     = Dataset.voc2007_test_ss(dataset, 'test', false);
fprintf('Done.\n');

fprintf('-------------------- TRAINING --------------------\n');
train_time                  = tic;
opts.rfcn_model             = weakly_co_train_v4(dataset.imdb_train, dataset.roidb_train, models, ...
