...
% model
models                      = cell(1,1);
models{1}.solver_def_file   = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'vgg19_cvgj', 'solver_lr1_3.prototxt');
models{1}.test_net_def_file = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'vgg19_cvgj', 'test.prototxt');
models{1}.net_file          = fullfile(pwd, 'models', 'pre_trained_models',  'VGG19_cvgj', 'vgg19_cvgj_iter_300000.caffemodel');
models{1}.cur_net_file      = 'unset';
models{1}.name              = 'VGG19cvgj-Fast';
models{1}.conf              = fast_rcnn_config('image_means', 0, ...
