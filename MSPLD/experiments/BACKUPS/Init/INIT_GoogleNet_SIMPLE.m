...
% model
models                      = cell(1,1);
models{1}.solver_def_file   = fullfile(pwd, 'models', 'rfcn_prototxts', 'GoogleNet', 'solver_lr1_3.prototxt');
models{1}.test_net_def_file = fullfile(pwd, 'models', 'rfcn_prototxts', 'GoogleNet', 'test.prototxt');
models{1}.net_file          = fullfile(pwd, 'models', 'pre_trained_models', 'GoogleNet', 'bvlc_googlenet.caffemodel');
models{1}.cur_net_file      = 'unset';
models{1}.name              = 'GoogleNet-SIMPLE';
