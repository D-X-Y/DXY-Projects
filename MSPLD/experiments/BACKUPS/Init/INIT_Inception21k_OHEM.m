...
% model
models                      = cell(1,1);
models{1}.solver_def_file   = fullfile(pwd, 'models', 'rfcn_prototxts', 'Inception21k_OHEM', 'solver_lr1_3.prototxt');
models{1}.test_net_def_file = fullfile(pwd, 'models', 'rfcn_prototxts', 'Inception21k_OHEM', 'test.prototxt');
models{1}.net_file          = fullfile(pwd, 'models', 'pre_trained_models', 'Inception21k', 'Inception21k.caffemodel');
models{1}.cur_net_file      = 'unset';
models{1}.name              = 'Inception21k-OHEM';
models{1}.mean_image        = fullfile(pwd, 'models', 'pre_trained_models', 'Inception21k', 'mean_image.mat');
