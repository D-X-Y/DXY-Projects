...
% model
models                      = cell(1,1);
models{1}.solver_def_file   = fullfile(pwd, 'models', 'rfcn_prototxts', 'ResNet-50L_score_res3a', 'solver_lr1_3.prototxt');
models{1}.test_net_def_file = fullfile(pwd, 'models', 'rfcn_prototxts', 'ResNet-50L_score_res3a', 'test.prototxt');
...
models{1}.name              = 'ResNet50score-SIMPLE';
