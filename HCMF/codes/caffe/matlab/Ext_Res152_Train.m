caffe.set_mode_gpu();
gpu_id = 4;  % we will use the first gpu in this demo
caffe.set_device(gpu_id);
net_model = '../models/bvlc_resnet152/ResNet-152-deploy.prototxt';
net_weights = '../models/bvlc_resnet152/ResNet-152-model.caffemodel';
...
caffe.reset_all();
save('./VOC07_Train_res152.mat', 'res5c', 'imagelist', '-v7.3');
