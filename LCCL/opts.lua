...
function M.parse(arg)
   ...
   cmd:option('-print_freq',      60,      'Frequency for print the log')
   cmd:option('-grid_size',       -1,      'grid size')
   cmd:option('-cal_sparsity',    50,      'Frequency for print the log')
   ...
   cmd:addTime(opt.netType .. opt.depth,'%F %T')
   local log_file = opt.save .. '/' .. opt.dataset .. '-' .. opt.netType .. '-' .. opt.depth .. '-' .. opt.nEpochs .. '.log'
   cmd:log(log_file, opt)
