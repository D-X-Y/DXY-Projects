function dataset = voc2007_test_ss(dataset, usage, use_flip, exclude_difficult_samples)
...
switch usage
    ...
    case {'test'}
        ...
        dataset.roidb_test    = dataset.imdb_test.roidb_func(dataset.imdb_test, 'with_selective_search', true, 'exclude_difficult_samples', exclude_difficult_samples);
    otherwise
