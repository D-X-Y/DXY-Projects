...
models                      = cell(1,1);
box_param                   = cell(1,1);
models{1}.solver_def_file   = fullfile(pwd, 'models', 'rfcn_prototxts', 'ResNet-50L_score_OHEM_res3a', 'solver_lr1_3.prototxt');
models{1}.test_net_def_file = fullfile(pwd, 'models', 'rfcn_prototxts', 'ResNet-50L_score_OHEM_res3a', 'test.prototxt');
...
models{1}.name              = 'Res50s-OHEM-Rfcn';
...
opts.cache_name             = [opts.cache_name, '-nms_', num2str(nms_thresh), '_', num2str(cof_thresh), '-seed_', num2str(rng_seed), ...
                                    '-l_', models{1}.conf.step_epoch, '_', models{1}.conf.max_epoch, '-', difficult_string];
