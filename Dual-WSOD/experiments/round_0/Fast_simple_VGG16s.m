...
opts.gpu_id                 = auto_select_gpu(); %% 4 -> 0
...
print_result                = true;
exclude_difficult_samples   = true;
use_flipped                 = true;
rng_seed                    = 5;
% model
models                      = cell(1,1);
box_param                   = cell(1,1);
models{1}.solver_def_file   = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'vgg_16_score', 'solver_lr1_3.prototxt');
models{1}.test_net_def_file = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'vgg_16_score', 'test.prototxt');
models{1}.net_file          = fullfile(pwd, 'models', 'pre_trained_models', 'VGG16', 'vgg16.caffemodel');
models{1}.cur_net_file      = 'unset';
models{1}.name              = 'VGG16s-SIMPLE-FAST';
