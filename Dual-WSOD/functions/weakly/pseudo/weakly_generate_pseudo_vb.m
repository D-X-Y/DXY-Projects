function [image_roidb_train] = weakly_generate_pseudo_vb(test_models, image_roidb_train)
    ...
    for index = 1:num_roidb
        ...
        final_boxes = (all_boxess{index}  + reverse_box(all_boxess{reverse_idx}, image_roidb_train(reverse_idx).im_size) ) / 2;
