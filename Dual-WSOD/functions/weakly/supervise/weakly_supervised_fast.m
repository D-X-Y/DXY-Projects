function model_path = weakly_supervised_fast(roidb_train, solver_file, model_file, val_interval, box_param, conf, cache_dir, prefix, suffix, final_name)
  ...
  fprintf('********** %6s Fast R-CNN Training : total[%5d] max_iter[%6d] *************\n', prefix, total_num, max_iter);
...
function model_path = weakly_snapshot(caffe_solver, bbox_means, bbox_stds, model_path)
